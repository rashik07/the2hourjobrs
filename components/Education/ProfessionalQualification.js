...
import {  createQualification,viewQualification,deleteQualification } from "@/redux/actions/usereducationAction";
import {  DeleteOutlined } from '@ant-design/icons';
const ProfessionalQualification = ({  createQualification,viewQualification,deleteQualification ,view_qualification}) => {
  useEffect(() => {
     ...
     
      {
        ...
        render: (details) => (
          ...
          <Space size="middle">
             ...
             <DeleteOutlined  key="ellipsis" onClick={()=>{deleteQualification(details.id);window.location.reload()}} 
...
export default connect(mapStateToProps, { createQualification,viewQualification,deleteQualification})(ProfessionalQualification);