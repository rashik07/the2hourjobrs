...
const renderimage = (announcment) => {
  if (announcment.image) {
    return (
      <Image
        src={"http://127.0.0.1:8000" + announcment.image[0]}
...
const editAnnouncementForm = ({ announcement, updateAnnouncement }) => {
...
export default connect(null, { updateAnnouncement })(editAnnouncementForm);
